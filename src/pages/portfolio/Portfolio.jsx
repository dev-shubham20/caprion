...
export default function Portfolio() {
    ...
    const products = [
        ...
        { id: 'CAP-N05', name: 'NAXRION D', therapy: 'Neurology', description: 'Non-steroidal anti-inflammatory drug (NSAID) that relieves pain in Migraine, muscle aches, and dental pain, and offers excellent therapy for rheumatoid conditions.', image: NAXRION_D },
        { id: 'CAP-N06', name: 'FLUPEXA', therapy: 'Neurology', description: 'Antipsychotic and anxiolytic drug, effective for somatoform disorders, irritable bowel syndrome (IBS), and psychosomatic disorders. It is also effective in the management of both primary and secondary symptoms of psychotic disorders.', image: FLUPEXA },
        ...
        // Gastroenterology
        { id: 'CAP-G01', name: 'ALCOBEST TAB', therapy: 'Gastroenterology', description: 'In Alcoholic Liver Disease,a balanced blend of essential B-vitamins supports nerve health, boosts energy, and helps manage nutritional deficiencies.', image: ALCOBEST },
        { id: 'CAP-G02', name: 'ALCOBEST IV', therapy: 'Gastroenterology', description: 'In Alcoholic Liver Disease, a fast-acting injectable blend of B-complex vitamins, Vitamin C, and dextrose supports nerve health and boosts energy.', image: ALCOBEST_IV },
        ...
        { id: 'CAP-G09', name: 'GLUTAZEST', therapy: 'Gastroenterology', description: 'In Alcoholic Liver Disease & Non-Alcoholic Fatty Liver Disease, decreases ALT and TG levels to improve liver function, protects the liver against hepato-toxic drugs, and improves response to antiviral and hepatitis therapies.', image: GLUTAZEST },
        { id: 'CAP-G10', name: 'URSOPAX', therapy: 'Gastroenterology', description: 'Prevents and reverses alcohol-induced damage, normalises liver function tests, and prevents TNF receptor activation and apoptosis.', image: UROSPAX },
